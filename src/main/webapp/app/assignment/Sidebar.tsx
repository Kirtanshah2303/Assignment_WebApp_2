    ...
    <div className="side" style={{ display: 'flex', height: '100vh', overflow: 'scroll initial' }}>
      <CDBSidebar textColor="#333" backgroundColor="#fff">
        <CDBSidebarHeader prefix={<i className="fa fa-bars fa-large"></i>}>
          <a href="/assignments" className="text-decoration-none" style={{ color: '#333' }}>
            CRNS
          </a>
        </CDBSidebarHeader>
        ...
        <CDBSidebarContent className="sidebar-content">
          <CDBSidebarMenu>
            <NavLink to={`${url}/assignment1`} activeClassName="activeLink">
              <CDBSidebarMenuItem className="navlink">Assignment 1</CDBSidebarMenuItem>
            </NavLink>
            <NavLink to={`${url}/assignment2`} activeClassName="activeLink">
              <CDBSidebarMenuItem className="navlink">Assignment 2</CDBSidebarMenuItem>
            </NavLink>
            <NavLink to={`${url}/assignment3`} activeClassName="activeLink">
